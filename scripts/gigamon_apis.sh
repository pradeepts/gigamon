...
data="{\"id\" : \"\",\"connAlias\" : \"azure\", \"connId\" : \"$d\",\"mtu\" : 1450,\"agentTunnelType\" : \"vxlan\",\"usePublicIps\" : false,\"diskType\" : \"SSD\",\"authenticationType\" : \"password\",\"password\": \"$password\",\"resourceGroupName\" : \"$rg_name\",\"virtualNetworkId\" : \"$vnet_id\",\"fabricNodeConfigs\" : [ {  \"imageId\" : \"gigamon-gvtap-cntlr-1.3-205-Marketplace\", \"imageName\" : \"gigamon-gvtap-cntlr-1.3-205-Marketplace\", \"size\" : \"Standard_DS1_v2\", \"numOfInstancesToLaunch\" : 1} ],\"mgmtSubnetSpec\" : {  \"subnetId\" : \"$vnet_id/subnets/$subnet1_name\",  \"subnetName\" : \"$subnet1_name\", \"acceleratedNetworking\" : false, \"networkSecurityGroups\" : [ { \"networkSecurityGroupId\" : \"$nsg_id\", \"networkSecurityGroupName\" : \"$nsg_name\" }]}}"
...
sleep 3
data1="{ \"id\": \"\",    \"connAlias\": \"azure\", \"connId\": \"$d\", \"usePublicIps\": false, \"diskType\": \"SSD\", \"authenticationType\": \"password\", \"password\": \"$password\", \"resourceGroupName\": \"$rg_name\", \"size\": \"Standard_DS1_v2\", \"imageId\": \"gigamon-gigavue-vseries-cntlr-1.4-010-Marketplace\", \"imageName\": \"gigamon-gigavue-vseries-cntlr-1.4-010-Marketplace\", \"virtualNetworkId\": \"$vnet_id\", \"mgmtSubnetSpec\": { \"subnetId\": \"$vnet_id/subnets/$subnet1_name\", \"subnetName\": \"$subnet1_name\", \"acceleratedNetworking\": false, \"networkSecurityGroups\": [ { \"networkSecurityGroupId\": \"$nsg_id\", \"networkSecurityGroupName\": \"$nsg_name\" }]},\"numOfInstancesToLaunch\": 1}"
